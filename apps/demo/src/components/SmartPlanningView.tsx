...
/**
 * Planning intelligent : une frise par phase (durées métier + séchage), avec
 * les jalons à anticiper — « à commander avant » et « choix à figer avant ».
 * Dérivé du dossier (vivant), pas une table de dates figée.
 */
