 ...
 *
 * L'analyse est injectable derrière un port (`DossierAnalyzer`) : par défaut
 * `realAnalyzeDossier` (LECTURE RÉELLE du devis, aucune donnée inventée) ; un
 * fournisseur plus riche (LLM + OCR) viendra plus tard SANS changer les écrans.
 * Aucune analyse scénarisée/mock : le devis validé est la seule source de vérité.
 *
